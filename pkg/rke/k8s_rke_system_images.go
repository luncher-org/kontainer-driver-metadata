...
func loadK8sRKESystemImages() map[string]v3.RKESystemImages {
	return map[string]v3.RKESystemImages{
		...
		"v1.33.0-luncher1": {
			Etcd:                      "rancher/mirrored-coreos-etcd:v3.5.21",
			Kubernetes:                "ghcr.io/luncher-org/hyperkube:v1.33.0-luncher1",
			Alpine:                    "rancher/rke-tools:v0.1.111",
			NginxProxy:                "rancher/rke-tools:v0.1.111",
			CertDownloader:            "rancher/rke-tools:v0.1.111",
			KubernetesServicesSidecar: "rancher/rke-tools:v0.1.111",
		...
		"v1.33.1-luncher1": {
			Etcd:                      "rancher/mirrored-coreos-etcd:v3.5.21",
			Kubernetes:                "ghcr.io/luncher-org/hyperkube:v1.33.1-luncher1",
			Alpine:                    "rancher/rke-tools:v0.1.113",
			NginxProxy:                "rancher/rke-tools:v0.1.113",
			CertDownloader:            "rancher/rke-tools:v0.1.113",
			KubernetesServicesSidecar: "rancher/rke-tools:v0.1.113",
		...
		"v1.33.2-luncher1": {
			Etcd:                      "rancher/mirrored-coreos-etcd:v3.5.21",
			Kubernetes:                "ghcr.io/luncher-org/hyperkube:v1.33.2-luncher1",
			Alpine:                    "rancher/rke-tools:v0.1.113",
			NginxProxy:                "rancher/rke-tools:v0.1.113",
			CertDownloader:            "rancher/rke-tools:v0.1.113",
			KubernetesServicesSidecar: "rancher/rke-tools:v0.1.113",
