...
func loadK8sRKESystemImages() map[string]v3.RKESystemImages {
	return map[string]v3.RKESystemImages{
		...
		// Testing Luncher images
		"v1.33.0-alpha.3-luncher1": {
			Etcd:                      "rancher/mirrored-coreos-etcd:v3.5.18",
			Kubernetes:                "ghcr.io/luncher-org/hyperkube:v1.33.0-alpha.3-luncher1",
			Alpine:                    "rancher/rke-tools:v0.1.111",
			NginxProxy:                "rancher/rke-tools:v0.1.111",
			CertDownloader:            "rancher/rke-tools:v0.1.111",
			KubernetesServicesSidecar: "rancher/rke-tools:v0.1.111",
		...
		"v1.33.0-beta.0-luncher1": {
			Etcd:                      "rancher/mirrored-coreos-etcd:v3.5.17",
			Kubernetes:                "ghcr.io/luncher-org/hyperkube:v1.33.0-beta.0-luncher1",
			Alpine:                    "rancher/rke-tools:v0.1.111",
			NginxProxy:                "rancher/rke-tools:v0.1.111",
			CertDownloader:            "rancher/rke-tools:v0.1.111",
			KubernetesServicesSidecar: "rancher/rke-tools:v0.1.111",
